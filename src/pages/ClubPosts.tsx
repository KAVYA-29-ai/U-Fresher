...
const ClubPosts = ({ clubId, clubName, onBack }: ClubPostsProps) => {
  ...
  const renderPost = (post: any) => (
    <Card key={post.id} className="bg-white/80 backdrop-blur-sm border-0 shadow-lg shadow-blue-500/5 rounded-2xl hover:shadow-xl transition-all duration-300">
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-base text-slate-800">{post.author?.name || 'Unknown User'}</CardTitle>
        ...
        <div className="space-y-4">
          ...
          {post.moderation_reason && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
              ...
              <p className="text-sm text-yellow-700 mt-1">{post.moderation_reason}</p>
            </div>
          )}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-800">{clubName}</h1>
          <p className="text-slate-600">Share your thoughts and connect with club members</p>
        </div>
      </div>
      ...
      <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl shadow-blue-500/10 rounded-2xl">
        <CardHeader>
          <CardTitle className="text-lg text-slate-800">Create a Post</CardTitle>
        ...
        <CardContent className="space-y-4">
          <Textarea
            ...
            className="min-h-[100px] bg-slate-50/50 border-slate-200 rounded-xl resize-none"
          />
      ...
      <div className="space-y-6">
        ...
        {loading ? (
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <Card key={i} className="bg-white/80 backdrop-blur-sm border-0 shadow-lg shadow-blue-500/5 rounded-2xl">
                <CardHeader className="pb-3">
                  <div className="flex items-center gap-3">
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl shadow-blue-500/10 rounded-2xl">
            <CardContent className="text-center py-12">
              ...
              <p className="text-slate-600 mb-4">Be the first to share something with the club</p>
              <Button
